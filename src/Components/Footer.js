    ...
    return (
        <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
            <div className="grid grid-flow-col gap-4">
                {user && <>
                <Link to='/add-todos' className="link link-hover">Add Todos</Link>
                <Link to='/your-todos' className="link link-hover">Your Todos</Link>
                </>}
            </div>
            <div>
                <p>Copyright © 2022 - All right reserved by Humayra Nur</p>
            </div>
            <div>
                <div className="grid grid-flow-col gap-4">
